...
import { resolve, resolveProperties, UNRESOLVED, NOVALUE, hasUnresolved } from '../src/normalize/intrinsic-resolver.js';

function ctx(over: Partial<ResolverContext> = {}): ResolverContext {
  return {
    params: { Env: 'prod' },
    pseudo: { 'AWS::Region': 'us-east-1', 'AWS::AccountId': '123', 'AWS::Partition': 'aws', 'AWS::URLSuffix': 'amazonaws.com', 'AWS::StackName': 'S', 'AWS::StackId': 'id' },
    conditions: {},
