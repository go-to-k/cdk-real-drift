...
v0.27.0 were generated by semantic-release, which released on every merge
to `main` before the switch to batched release PRs.

## [0.28.0](https://github.com/go-to-k/cdk-real-drift/compare/v0.27.0...v0.28.0) (2026-09-20)


### ⚠ BREAKING CHANGES

* **deps:** raise the published Node.js floor from 20 to 22.12 across engines, the pack target, the CI matrix and the docs ([#1906](https://github.com/go-to-k/cdk-real-drift/issues/1906))

### Bug Fixes

* **ci:** replace the step-if exemption predicate, which was inert on this tree ([#1900](https://github.com/go-to-k/cdk-real-drift/issues/1900)) ([e420f2c](https://github.com/go-to-k/cdk-real-drift/commit/e420f2cbee076201f0da59cd399ae4924bd48a7f))


### Miscellaneous Chores

* **deps:** raise the published Node.js floor from 20 to 22.12 across engines, the pack target, the CI matrix and the docs ([#1906](https://github.com/go-to-k/cdk-real-drift/issues/1906)) ([a433e25](https://github.com/go-to-k/cdk-real-drift/commit/a433e25c767a78dab874779907a606097f9cc281))
